/*
	...
	Important: Do not modify this file. Edit the file VwInstituteDegreeCourses.cs instead.
*/
...
namespace GE.MyLearning.BL
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VwInstituteDegreeCoursesBase")]
	public abstract partial class VwInstituteDegreeCoursesBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// DegreeId : 
		/// </summary>
		private System.Int32?		  _degreeId = null;
		...
		/// DegreeCourseID : 
		/// </summary>
		private System.Int32?		  _degreeCourseId = null;
		...
		/// DegreeCourseStatus : 
		/// </summary>
		private System.Int32?		  _degreeCourseStatus = null;
		
		/// <summary>
		/// IsRequiredCourse : 
		/// </summary>
		private System.Int32?		  _isRequiredCourse = null;
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VwInstituteDegreeCoursesBase"/> instance.
		///</summary>
		public VwInstituteDegreeCoursesBase()
		{
		}		
		...
		public VwInstituteDegreeCoursesBase(System.String _instituteId, System.String _instituteName, System.String _description, System.String _instituteDean, System.Int32 _instituteStatus, System.Int32? _degreeId, System.String _degreeName, System.String _degreesDescription, System.Int32? _credithour, System.Int32? _degreeStatus, System.Int32? _degreeCourseId, System.String _courseName, System.Int32? _courseStyle, System.String _courseId, System.String _degreeCoursesDescription, System.Int32? _degreeCoursesCreditHour, System.Int32? _degreeCourseStatus, System.Int32? _isRequiredCourse)
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="VwInstituteDegreeCourses"/> instance.
		///</summary>
		///<param name="_instituteId"></param>
		///<param name="_instituteName"></param>
		///<param name="_description"></param>
		...
		///<param name="_degreeCourseStatus"></param>
		///<param name="_isRequiredCourse"></param>
		public static VwInstituteDegreeCourses CreateVwInstituteDegreeCourses(System.String _instituteId, System.String _instituteName, System.String _description, System.String _instituteDean, System.Int32 _instituteStatus, System.Int32? _degreeId, System.String _degreeName, System.String _degreesDescription, System.Int32? _credithour, System.Int32? _degreeStatus, System.Int32? _degreeCourseId, System.String _courseName, System.Int32? _courseStyle, System.String _courseId, System.String _degreeCoursesDescription, System.Int32? _degreeCoursesCreditHour, System.Int32? _degreeCourseStatus, System.Int32? _isRequiredCourse)
		{
			VwInstituteDegreeCourses newVwInstituteDegreeCourses = new VwInstituteDegreeCourses();
			newVwInstituteDegreeCourses.InstituteId = _instituteId;
			newVwInstituteDegreeCourses.InstituteName = _instituteName;
			newVwInstituteDegreeCourses.Description = _description;
			newVwInstituteDegreeCourses.InstituteDean = _instituteDean;
			newVwInstituteDegreeCourses.InstituteStatus = _instituteStatus;
			newVwInstituteDegreeCourses.DegreeId = _degreeId;
			newVwInstituteDegreeCourses.DegreeName = _degreeName;
			newVwInstituteDegreeCourses.DegreesDescription = _degreesDescription;
			newVwInstituteDegreeCourses.Credithour = _credithour;
			newVwInstituteDegreeCourses.DegreeStatus = _degreeStatus;
			newVwInstituteDegreeCourses.DegreeCourseId = _degreeCourseId;
			newVwInstituteDegreeCourses.CourseName = _courseName;
			newVwInstituteDegreeCourses.CourseStyle = _courseStyle;
			newVwInstituteDegreeCourses.CourseId = _courseId;
			newVwInstituteDegreeCourses.DegreeCoursesDescription = _degreeCoursesDescription;
			newVwInstituteDegreeCourses.DegreeCoursesCreditHour = _degreeCoursesCreditHour;
			newVwInstituteDegreeCourses.DegreeCourseStatus = _degreeCourseStatus;
			newVwInstituteDegreeCourses.IsRequiredCourse = _isRequiredCourse;
			return newVwInstituteDegreeCourses;
		}
		...
		public virtual System.Int32? DegreeId
		{
			...
			set
			{
				if (_degreeId == value && DegreeId != null )
					return;
		...
		public virtual System.Int32? DegreeCourseId
		{
			...
			set
			{
				if (_degreeCourseId == value && DegreeCourseId != null )
					return;
		...
		public virtual System.Int32? DegreeCourseStatus
		{
			...
			set
			{
				if (_degreeCourseStatus == value && DegreeCourseStatus != null )
					return;
		...
		public virtual System.Int32? IsRequiredCourse
		{
			...
			set
			{
				if (_isRequiredCourse == value && IsRequiredCourse != null )
					return;
		...
		{
			get { return "VW_InstituteDegreeCourses"; }
		}
		...
		///</summary>
		public virtual VwInstituteDegreeCoursesBase Copy()
		{
			//shallow copy entity
			VwInstituteDegreeCourses copy = new VwInstituteDegreeCourses();
			...
			copy.AcceptChanges();
			return (VwInstituteDegreeCourses)copy;
		}
		...
		///<returns>true if toObject is a <see cref="VwInstituteDegreeCoursesBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VwInstituteDegreeCoursesBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VwInstituteDegreeCoursesBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VwInstituteDegreeCoursesBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VwInstituteDegreeCoursesBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VwInstituteDegreeCoursesBase Object1, VwInstituteDegreeCoursesBase Object2)
		{
			// both are null
			...
			else if (Object1.DegreeId == null ^ Object1.DegreeId == null )
			{
				equal = false;
			}
			...
			if (Object1.DegreeCourseId != null && Object2.DegreeCourseId != null )
			{
				if (Object1.DegreeCourseId != Object2.DegreeCourseId)
					equal = false;
			}
			else if (Object1.DegreeCourseId == null ^ Object1.DegreeCourseId == null )
			{
				equal = false;
			}
			...
			if (Object1.DegreeCourseStatus != null && Object2.DegreeCourseStatus != null )
			{
				if (Object1.DegreeCourseStatus != Object2.DegreeCourseStatus)
					equal = false;
			}
			else if (Object1.DegreeCourseStatus == null ^ Object1.DegreeCourseStatus == null )
			{
				equal = false;
			}
			if (Object1.IsRequiredCourse != null && Object2.IsRequiredCourse != null )
			{
				if (Object1.IsRequiredCourse != Object2.IsRequiredCourse)
					equal = false;
			}
			else if (Object1.IsRequiredCourse == null ^ Object1.IsRequiredCourse == null )
			{
				equal = false;
			}
			return equal;
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VwInstituteDegreeCourses entity, string propertyName)
		{
			switch (propertyName)
			{
				case "InstituteId":
		...
		{			
			return GetPropertyValueByName(this as VwInstituteDegreeCourses, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{19}{18}- InstituteId: {0}{18}- InstituteName: {1}{18}- Description: {2}{18}- InstituteDean: {3}{18}- InstituteStatus: {4}{18}- DegreeId: {5}{18}- DegreeName: {6}{18}- DegreesDescription: {7}{18}- Credithour: {8}{18}- DegreeStatus: {9}{18}- DegreeCourseId: {10}{18}- CourseName: {11}{18}- CourseStyle: {12}{18}- CourseId: {13}{18}- DegreeCoursesDescription: {14}{18}- DegreeCoursesCreditHour: {15}{18}- DegreeCourseStatus: {16}{18}- IsRequiredCourse: {17}{18}", 
				this.InstituteId,
				...
				(this.DegreeCourseId == null) ? string.Empty : this.DegreeCourseId.ToString(),
				...
				(this.DegreeCourseStatus == null) ? string.Empty : this.DegreeCourseStatus.ToString(),
			     
				(this.IsRequiredCourse == null) ? string.Empty : this.IsRequiredCourse.ToString(),
	...
	/// </summary>
	[Serializable]
	public enum VwInstituteDegreeCoursesColumn
	{
		/// <summary>
		/// InstituteID : 
		/// </summary>
		...
		[ColumnEnum("DegreeCourseID", typeof(System.Int32), System.Data.DbType.Int32, false, false, true)]
		DegreeCourseId,
		/// <summary>
		/// CourseName : 
		/// </summary>
		...
		[ColumnEnum("DegreeCourseStatus", typeof(System.Int32), System.Data.DbType.Int32, false, false, true)]
		DegreeCourseStatus,
		/// <summary>
		/// IsRequiredCourse : 
		/// </summary>
		[EnumTextValue("IsRequiredCourse")]
		[ColumnEnum("IsRequiredCourse", typeof(System.Int32), System.Data.DbType.Int32, false, false, true)]
		IsRequiredCourse
	}//End enum
